...
1. Import Account data:
    ...
    - Drag the **accounts.csv** file you just saved and drop in in the upload area.
...
1. Import Product Family data:
    ...
    - Drag the **product_families.csv** file you just saved and drop in in the upload area.
    - Click **Next**, **Next**, and **Start Import**.
...
1. Import Product data:
    ...
    - Drag the **products.csv** file you just saved and drop in in the upload area.
    - Click **Next**, **Next**, and **Start Import**.
